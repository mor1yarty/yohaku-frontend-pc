  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow text-sm text-gray-800 space-y-3">
      <div className="flex items-center gap-2">
        ...
        <span className="bg-[#CCE0F3] font-semibold px-3 py-1 rounded-full w-fit">
            録音時間：{duration}
        </span>
      </div>

      <div className="leading-relaxed text-base whitespace-pre-line border border-gray-300 rounded-md p-3 h-[14rem] overflow-y-auto">
        {summary}
      </div>

      <div className="flex items-center justify-between pt-2">
        <span className="text-[#3171CE]">文字数：{charCount}</span>
